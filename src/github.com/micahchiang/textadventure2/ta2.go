...
func main() {
	...
	start := storyNode{text: `
		You are in a large chamger, deep underground.
	...
	trap := storyNode{text: "You head down the well traveled path when suddenly a trap door opens and you fall to your death."}
